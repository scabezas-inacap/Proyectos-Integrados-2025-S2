...
Envíe su presentación al correo docente: sebastian.cabezas07@inacapmail.cl con los integrantes de su equipo.
...
- Deberán presentar en el siguiente orden:
- 23, 12, 5, 30, 2, 18, 14, 32, 7, 26, 1, 9, 29, 4, 16, 11, 20, 3, 27, 22, 10, 8, 25, 6, 21, 15, 31, 19, 13, 24, 28, 17
- Si su grupo o número ya salió, se irán descartando para ir avanzando.
- Cuando comience la ronda de preguntas, saldrá un número al azar y deberá hacer la pregunta la persona del número correspondiente.
- La misma pregunta se puede repetir hasta 3 veces durante todo el proceso (No así en la misma presentación).
- Si se realiza nuevamente la misma pregunta (ya descartada porque salió tres veces), su grupo (el que pregunta) tendrá nota máxima un 4,0. Si el grupo tiene nota 4,0, entonces pasa a ser nota 3,0. 

## Lista de participates y número asignado:

1. Acevedo, Nahuel
2. Adriazola, Alejandro
3. Araujo, Sebastián
4. Arriaza, Fernando
5. Astete, Javier
6. Astudillo, David
...
18. Morales, Antonio
19. Otero, Daniel
20. Palacios, Francisco
21. Pino, Yetsabel
22. Pulgar, Ignacio
23. Reyes, Catalina
24. Rivano, María Antonieta
25. Salazar, Bastián
26. Saravia, Jocelyn
27. Troncoso, Javiera
28. Valenzuela, Paola
